...
class SubscriptionRepository extends BaseRepository
{
    ...
    public function paymentUpdate($request)
    {
        try {
            ...
            $title = "You successfully received subscription plan amount ".getSubscriptionPlanCurrencyIcon($sessionData->metadata->plan_currency).$paymentAmount." from ".Auth::user()->full_name.".";
            addNotification([

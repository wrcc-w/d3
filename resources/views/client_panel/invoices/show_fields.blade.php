                                ...
                                <div class="flex-lg-row-fluid me-xl-18 mb-10 mb-xl-0">
                                    <div class="mt-n1">
                                        <div class="d-flex flex-stack pb-10">
                                            <img alt="Logo" src="{{ asset('assets/images/infyom.png') }}" height="100px"
                                                 width="100px"
                                        ...
                                        <div class="m-0">
                                            <div class="fw-bolder fs-3 text-gray-800 mb-8">Invoice
                                                    ...
                                                    <div class="mw-300px">
                                                        <div class="d-flex flex-stack mb-3">
                                                            ...
                                                            <div class="text-end fw-bolder fs-6 text-gray-800">
                                                                <b>{{ getCurrencySymbol() }}</b> {{ numberFormat($invoice->amount,2)??'N/A' }}
                                                            </div>
                                                        </div>
                                                        <div class="d-flex flex-stack mb-3">
                                    ...
                                    <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 p-9 bg-lighten">
                                        ...
                                        <div class="mb-6">
                                            ...
                                            <div class="fw-bolder fs-6 text-gray-800">
                                                <span
                                                        class="link-primary">{{ $invoice->client->user->full_name }}</span>
                                            </div>
                                        </div>
                                        <div class="mb-6">
                                    ...
                                    <div class="d-print-none border border-dashed border-gray-300 card-rounded h-lg-100 p-9 bg-lighten">
                                        <div class="mb-6">
                                            ...
                                            <div class="fw-bolder text-gray-800 fs-6">
                                                {{ getCurrencySymbol() }}
                                                &nbsp;{{ numberFormat($invoice->payments->sum('amount')) }}</div>
                                        </div>
                                        <div class="mb-6">

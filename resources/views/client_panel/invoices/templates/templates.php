<script id="invoiceActionTemplate" type="text/x-jsrender">
 <div class="dropup">
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><a class="dropdown-item" href="{{:pdfLink}}" target="_blank"><?php echo __('messages.invoice.download') ?></a></li>
    {{if status != 'Paid'}}
    <li><a class="dropdown-item payment" href="#" data-id="{{:id}}"><?php echo __('messages.invoice.make_payment') ?></a></li>
    {{/if}}
  </ul>
</div>

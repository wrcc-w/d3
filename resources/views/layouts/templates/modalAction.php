...
<a href="javascript:void(0)" data-id="{{:id}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit-btn" >
    ...
    <a href="javascript:void(0)" data-id="{{:id}}" class="delete-btn btn btn-icon btn-bg-light text-hover-primary btn-sm" data-bs-toggle="tooltip" title="Delete">
                        <span class="svg-icon svg-icon-3">

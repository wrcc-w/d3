            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['id'=>'editTaxName','class' => 'form-control form-control-solid', 'required','placeholder' => 'Tax Name']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('is_default',__('messages.tax.is_default').':', ['class' => 'form-label fs-6 fw-bolder text-gray-700 mb-3']) }}

                ...
                <div class="col-md-6 col-12">
                    <div class="card plan-card-shadow h-100 card-xxl-stretch p-5 ms-md-2">
                        ...
                        <div class="card-body py-3 px-0">
                            <div class="flex-stack">
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Plan Name</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">{{$newPlan['name']}}</span>
                                </div>
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Plan Price</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">
                                        <span class="mb-2">
                                ...
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Start Date</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">{{$newPlan['startDate']}}</span>
                                </div>
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">End Date</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">{{$newPlan['endDate']}}</span>
                                </div>
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Total Days</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">{{$newPlan['totalDays']}} Days</span>
                                </div>
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Remaining Balance
                                        of
                                        Prev. Plan</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">
                                        {{ getSubscriptionPlanCurrencyIcon($subscriptionsPricingPlan->currency) }}
                                ...
                                <div class="d-flex align-items-center plan-border-bottom py-2">
                                    <h4 class="fs-5 w-50 plan-data mb-0 me-5 text-gray-800 fw-bolder">Payable
                                        Amount</h4>
                                    <span class="fs-5 text-muted fw-bold mt-1">
                                        {{ getSubscriptionPlanCurrencyIcon($subscriptionsPricingPlan->currency) }}
                                        {{$newPlan['amountToPay']}}

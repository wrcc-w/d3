                    ...
                    <div class="w-100 d-flex flex-column flex-center rounded-3 bg-light bg-opacity-75 py-15 px-10">
                        <div class="text-center">
                            ...
                            <div class="mt-2 border border-gray-400 {{ $planData['totalDays'] > 0 ? 'd-none' : '' }}">
                                {{ Form::select('payment_type', $paymentTypes, \App\Models\Subscription::TYPE_STRIPE,
                                ['class' => 'form-select form-select-solid','required', 'id' => 'paymentType',
                            ...
                            <div class="mt-5 stripePayment proceed-to-payment">
                                <button type="button"
                                    ...
                                    {{ __('messages.subscription_pricing_plans.proceed_to_payment') }}
                                </button>
                            </div>

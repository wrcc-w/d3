            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('icon', null, ['id'=>'icon','class' => 'form-control form-control-solid','required']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('code', __('messages.currency.currency_code').':', ['class' => 'required fw-bold fs-6 mb-2']) }}
                        {{ Form::text('code', null, ['class' => 'form-control form-control-solid mb-3 mb-lg-0', 'placeholder' =>                                        'Currency Code','required']) }}

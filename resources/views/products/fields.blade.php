<div class="row gx-10 mb-5">
    <div class="col-lg-6">
        <div class="mb-5">
            ...
            {{ Form::text('name',null,['class' => 'form-control form-control-solid', 'placeholder' => 'Product Name', 'required','onkeypress'=>"return blockSpecialChar(event)"]) }}
        </div>
    </div>
    <div class="col-lg-6">
        ...
        <div class="input-group mb-5">
            {{ Form::text('code', null, ['class' => 'form-control form-control-solid', 'placeholder' => 'Product Code', 'required', 'id' => 'code', 'maxlength' => 6,'onkeypress'=>"return blockSpecialChar(event)",]) }}
    ...
    <div class="col-lg-6">
        <div class="input-group mb-5">
            ...
            {{ Form::select('category_id', $categories ,null, ['id'=>'categoryId', 'class' => 'form-select form-select-solid', 'placeholder' => 'Select Category', 'required', 'data-control' => 'select2']) }}
        </div>
    </div>
    <div class="col-lg-6">
        <div class="mb-5">
            {{ Form::label('unit_price', __('messages.product.unit_price').':', ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
            {{ Form::number('unit_price',null,['id'=>'unitPriceId','class' => 'form-control form-control-solid', 'placeholder' => 'Unit Price','min'=>'0', 'step'=>".01", 'oninput'=>"validity.valid||(value=value.replace(/\D+/g, '.'))",'required']) }}
        </div>
    </div>
    <div class="col-lg-12">
        <div class="mb-5">
    ...
    <div class="col-lg-3 mb-7">
        ...
        {{$styleCss}}="display: {{ !empty($product->product_image) ? 'block' : 'none' }}">
        <i class="bi bi-x fs-2"></i>
        </span>
    </div>

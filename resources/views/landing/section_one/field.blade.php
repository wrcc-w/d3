    ...
    <div class="form-group col-sm-6 mb-5">
        <div class="row2">
            ...
            <div class="image-input image-input-outline" data-kt-image-input="true">
                ...
                {{$style}}"{{$background}}
                url({{ isset($sectionOne['img_url_one']) ? asset($sectionOne['img_url_one']) : asset('landing-theme/images/feature-section-1-img.jpg') }}
                )">
            </div>
            <label
                ...
                {{ Form::file('img_url_one',['class' => 'd-none','accept' => '.png, .jpg, .jpeg']) }}
...
<div class="form-group col-sm-12 mb-5">
    ...
    {{ Form::text('text_main', $sectionOne['text_main'], ['class' => 'form-control form-control-solid', 'id' => 'textMain','maxLength' => '45','placeholder' => 'Enter Text Main']) }}
</div>
...
<div class="form-group col-sm-12 mb-5">
    ...
    {{ Form::text('text_secondary', $sectionOne['text_secondary'], ['class' => 'form-control form-control-solid', 'id' => 'textSecondary', 'required','maxLength' => '191','placeholder' => 'Enter Text Secondary']) }}
</div>

                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-12 mb-5">
                            ...
                            {{ Form::text('question', null, ['class' => 'form-control form-control-solid','required','id' => 'editQuestion','placeholder' => 'Enter Question']) }}
                        </div>
                        <div class="form-group col-sm-12 mb-5">
                            {{ Form::label('answer', __('messages.faqs.answer').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                            {{ Form::textarea('answer', null, ['class' => 'form-control form-control-solid','required','id'=>'editAnswer', 'rows' => 6,'placeholder' => 'Enter Answer']) }}
                        </div>
                    </div>

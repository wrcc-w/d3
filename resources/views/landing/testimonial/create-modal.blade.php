            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <div class="row">
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        {{ Form::text('name', null, ['class' => 'form-control form-control-solid','required','placeholder' => 'Enter Name']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('designation
', __('messages.testimonial.designation').(':'), ['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::text('position', null, ['class' => 'form-control form-control-solid','required','placeholder' => 'Enter Designation']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        {{ Form::label('description', __('messages.testimonial.description').(':'),['class' => 'form-label required fs-6 fw-bolder text-gray-700 mb-3']) }}
                        {{ Form::textarea('description', null, ['class' => 'form-control form-control-solid description','rows' => 6,'placeholder' => 'Enter Description']) }}
                    </div>
                    <div class="form-group col-sm-12 mb-5">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true">
                            ...
                            <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                                 id="previewImage" {{$style}}"{{$background}}

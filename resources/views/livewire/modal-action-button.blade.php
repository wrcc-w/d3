...
@if(isset($value['show-route']))
    <a href="javascript:void(0)" data-id="{{$value['data-id']}}" title="Show" class="btn show-btn btn-icon btn-bg-light text-hover-primary btn-sm me-1" data-bs-toggle="tooltip">
        <i class="fas fa-eye fs-4"></i>
    </a>
@endif

    <a title="{{__('messages.common.edit')}}" data-id="{{ $value['data-id'] }}"
    ...
    <a title="{{__('messages.common.delete')}}" href="javascript:void(0)" data-id="{{ $value['data-id'] }}"
       class="btn faq-delete-btn btn-icon btn-bg-light text-hover-primary btn-sm ms-1 delete-btn">
                        <span class="svg-icon svg-icon-3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"
                             version="1.1">

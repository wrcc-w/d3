...
@if(isset($value['show-route']))
    <a href="{{ $value['show-route'] }}" title="Show"
...
@endif
<a href="#" data-id="{{ $value['data-id'] }}" class="delete-btn btn btn-icon btn-bg-light text-hover-primary btn-sm"

<script id="SuperAdminEnquiryActionTemplate" type="text/x-jsrender">
<a href="{{:showUrl}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1" data-bs-toggle="tooltip" title="Show"> 
    ...
    <a href="#" data-id={{:id}}" class="delete-btn btn btn-icon btn-bg-light text-hover-primary btn-sm" title="Delete">

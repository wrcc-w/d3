...
{{--                                     xmlns:xlink="https://www.w3.org/1999/xlink" width="24px" height="24px"--}}
...
{{--                                        {{Form::select('payment_mode',$paymentModeArr,null,['id'=>'paymentModeFilter','class'=>'form-select form-select-solid select2-hidden-accessible','placeholder'=>'Select a Payment Method','data-control' => 'select2','data-kt-select2'=>'true','data-dropdown-parent'=>'#kt_menu_6113c71822d0d'])  }}--}}
{{--                                    </div>--}}
{{--                                    <div class="d-flex justify-content-end">--}}
{{--                                        <button type="reset"--}}
{{--                                                class="btn btn-sm fs-6 btn-light btn-active-light-primary me-2"--}}
{{--                                                id="resetFilter"--}}

<div class="row">
    ...
    <div class="col-md-4 mb-5">
        <div class="form-group">
            ...
            {{ Form::text('name', null , ['class' => 'form-control form-control-solid','required','placeholder' => __('Enter Plan Name'),'id'=>'name']) }}
        </div>
    </div>
    ...
    <div class="col-md-4 mb-5 hide_for_trail">
        <div class="form-group">
            ...
            {{ Form::number('trial_days', null , ['class' => 'form-control form-control-solid price-input price for_trail_required','placeholder' => 'Enter Trial Days', 'id'=>'trialDays','oninput'=>"validity.valid||(value=value.replace(/[e\+\-]/gi,''))",'min'=>'0']) }}
        </div>
    </div>

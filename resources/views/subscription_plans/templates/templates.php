<script id="subscriptionPlanTemplate" type="text/x-jsrender">
    ...
    <a href="{{:url}}" title="<?php echo __('messages.common.edit') ?>" class="btn btn-icon btn-bg-light edit-btn btn-active-color-primary btn-sm me-1">
    ...
    {{if isDefault}}
    <a href="#" title="<?php echo __('messages.common.delete') ?>" data-id="{{:id}}" class="delete-btn btn btn-icon btn-bg-light text-hover-primary btn-sm">
            <span class="svg-icon svg-icon-3">

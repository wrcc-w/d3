...
window.defaultImagePreview = function (imagePreviewSelector) {
  $(imagePreviewSelector).css('background-image', 'url("' + defaultImageUrl + '")');
};
...
window.number_format = function (number) {
  ...
  var thousands_sep = thousandsSeparator; // Strip all characters but numerical ones.
...
window.isDoubleClicked = function (element) {
  ...
  if (element.data('isclicked')) return true; //mark as clicked for 1 second

  element.data('isclicked', true);
  setTimeout(function () {
    element.removeData('isclicked');
  }, 1000); //return FALSE to indicate this click was allowed

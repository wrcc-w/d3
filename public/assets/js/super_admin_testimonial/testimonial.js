...
$('#addModal').on('hidden.bs.modal', function () {
  ...
  $('#previewImage').attr('src', defaultDocumentImageUrl).css('background-image', "url(".concat(defaultDocumentImageUrl, ")"));
  $('#btnSave').attr('disabled', false);
});
...
$(document).on('click', '.delete-btn', function (event) {
  var testimonialId = $(event.currentTarget).data('id');
  deleteItem(route('admin-testimonial.destroy', testimonialId), $('#AdminTestimonialTbl'), 'Testimonial');
}); //

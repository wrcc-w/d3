    ...
    return {
        init: function () {
            e = document.querySelector(
                '#kt_sign_up_form'), t = document.querySelector(
                '#kt_sign_up_submit'), s = KTPasswordMeter.getInstance(
                e.querySelector(
                    '[data-kt-password-meter="true"]')), a = FormValidation.formValidation(
                e, {
                    fields: {
                ...
                r.preventDefault(), a.revalidateField('password'), a.validate().
                    then((function (a) {
                        'Valid' == a ? (t.setAttribute('data-kt-indicator',
                            'on'), t.disabled = !0, setTimeout((function () {
                            t.removeAttribute(
                                'data-kt-indicator'), t.disabled = !1, Swal.fire(
                                {

...
+function ($) {
    ...
    Validator.prototype.validateInput = function ($el, deferErrors) {
        ...
        if ($el.is('[type="radio"]')) $el = this.$element.find(
            ...
            if (!prevErrors || errors.toString() !== prevErrors.toString()) {
                e = errors.length
                    ? $.Event('invalid.bs.validator',
                        { relatedTarget: $el[0], detail: errors })
                    : $.Event('valid.bs.validator',
                        { relatedTarget: $el[0], detail: prevErrors })
    ...
    Validator.prototype.showErrors = function ($el) {
        ...
        errors = $('<ul/>').
            ...
            append($.map(errors,
                function (error) { return $('<li/>')[method](error) }))
    ...
    Validator.prototype.isIncomplete = function () {
        ...
        return !!this.$inputs.filter('[required]').
    ...
    Validator.prototype.reset = function () {
        ...
        this.$inputs.removeData(
            ['bs.validator.errors', 'bs.validator.deferred']).each(function () {
            var $this = $(this)
    ...
    function Plugin (option) {
        return this.each(function () {
            ...
            if (!data) $this.data('bs.validator',
